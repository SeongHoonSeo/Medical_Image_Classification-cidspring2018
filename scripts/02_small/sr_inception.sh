...
> ~/log/180518_3000_inception_r/eval0084.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0168.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0252.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0336.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0420.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0504.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0588.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0672.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0756.txt &&
nohup python ../train_image_classifier.py \
--save_interval_secs=300 --save_summaries_secs=300 \
--train_dir=/data/log_dir/180518_3000_inception_r \
...
--alsologtostderr --model_name=inception_v4 \
--checkpoint_path=/data/log_dir/180518_3000_inception_r \
> ~/log/180518_3000_inception_r/eval0840.txt
)&
