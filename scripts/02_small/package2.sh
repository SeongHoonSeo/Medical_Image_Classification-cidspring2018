...
> ~/log/180518_3000_inres_r/eval1680.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval2520.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval3360.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval4200.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval5040.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval5880.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval6720.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval7560.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
--train_dir=/data/log_dir/180518_3000_inres_r \
...
--alsologtostderr --model_name=inception_resnet_v2 \
--checkpoint_path=/data/log_dir/180518_3000_inres_r \
> ~/log/180518_3000_inres_r/eval8400.txt &&
nohup python ../../train_image_classifier.py \
--save_interval_secs=3000 --save_summaries_secs=3000 \
